...
Requires:       autotrace, bzip2, dcraw, djvulibre, fftw, fftw2
Requires:       freetype, ghostscript, giflib, graphviz, jasper
Requires:       jbig2dec, jbigkit, lcms2, libX11, libXext, libXt
Requires:       libjpeg, libpng, libraqm, librsvg2, libtiff
Requires:       libtool-ltdl, libwebp, libwmf, libxml2, OpenEXR
Requires:       openjpeg2, zlib 
...
BuildRequires:  jbig2dec-devel, fftw2-devel
BuildRequires:  autotrace-devel, graphviz-devel, dcraw
BuildRequires:  libraqm-devel
BuildRequires:	autoconf automake

Patch0:		ImageMagick-6.9.9-3-multiarch-implicit-pkgconfig-dir.patch
Patch1:         ImageMagick-dcraw-dng-delegates.xml.patch
...
Group: Applications/Multimedia
Provides: libMagickCore.so.5()(64bit) libMagickWand.so.5()(64bit)
...
#Requires: %{name}-libs%{?_isa} = %{epoch}:%{version}-%{release}
Requires: %{name}-libs%{?_isa} = %{version}-%{release}
Provides: /usr/lib64/libMagick++.so.8
...
%patch1 -p1 -b .dcraw-delegates-xml
...
cp %{buildroot}%{_libdir}/libMagickCore-6.Q16HDRI.so.5.0.0 %{buildroot}%{_libdir}/libMagickCore.so.5.0.0
cp %{buildroot}%{_libdir}/libMagickWand-6.Q16HDRI.so.5.0.0 %{buildroot}%{_libdir}/libMagickWand.so.5.0.0
cp %{buildroot}%{_libdir}/libMagick++-6.Q16HDRI.so.8.0.0 %{buildroot}%{_libdir}/libMagick++.so.8.0.0

for _x in .so .so.5 ; do
   ln -rs %{buildroot}%{_libdir}/libMagickCore.so.5.0.0 %{buildroot}%{_libdir}/libMagickCore${_x}
   ln -rs %{buildroot}%{_libdir}/libMagickWand.so.5.0.0  %{buildroot}%{_libdir}/libMagickWand${_x}
done
for _x in .so .so.8 ; do
   ln -rs %{buildroot}%{_libdir}/libMagick++-6.Q16HDRI.so.8.0.0 %{buildroot}%{_libdir}/libMagick++${_x}
done
...
%{_libdir}/libMagickCore-6.Q16HDRI.so.5*
%{_libdir}/libMagickWand-6.Q16HDRI.so.5*
...
%{_bindir}/Wand-config
%{_libdir}/libMagickCore-6.Q16HDRI.so
%{_libdir}/libMagickWand-6.Q16HDRI.so
%{_libdir}/pkgconfig/MagickCore.pc
%{_libdir}/pkgconfig/MagickCore-6.Q16HDRI.pc
%{_libdir}/pkgconfig/ImageMagick.pc
%{_libdir}/pkgconfig/ImageMagick-6.Q16HDRI.pc
%{_libdir}/pkgconfig/MagickWand.pc
%{_libdir}/pkgconfig/MagickWand-6.Q16HDRI.pc
%{_libdir}/pkgconfig/Wand.pc
%{_libdir}/pkgconfig/Wand-6.Q16HDRI.pc
...
%{_libdir}/libMagick++-6.Q16HDRI.so.8*
%{_libdir}/libMagick++.so.8*
...
%{_libdir}/libMagick++-6.Q16HDRI.so
%{_libdir}/pkgconfig/Magick++.pc
%{_libdir}/pkgconfig/Magick++-6.Q16HDRI.pc
%{_libdir}/pkgconfig/ImageMagick++.pc
%{_libdir}/pkgconfig/ImageMagick++-6.Q16HDRI.pc
%{_mandir}/man1/Magick++-config.*
...
- Removed Epoch
- Included dcraw patch for delegates.xml
- build additional delegates
